...
namespace Zisary.Areas.admin.Controllers
{
    public class ProductoController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ProductoId,Denominacion,Descripcion,Precio,Existencias,Activo,Categoria,Tag")] Producto producto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ProductoId,Denominacion,Descripcion,Precio,Existencias,Activo,Categoria,Tag")] Producto producto)
        {
            if (ModelState.IsValid)
            {
